...
export function buildSuggestion(group, { repo = 'preetmendpara/runs-at.dev' } = {}) {
  ...
  return {
    ...
    outline: [
      ...
      `Why it matters for people with a ${'name.runs-at.dev'} name`,
    ...
    links,
    seo: {
      title: `${title} · runs-at.dev`.slice(0, 60),
