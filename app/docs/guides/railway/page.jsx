...
export default function RailwayGuide() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <Lede>you.runs-at.dev serving a Railway service, over HTTPS, via CNAME.</Lede>
      ...
      <Section title="Steps">
        ...
        <ol className="list-decimal space-y-2 pl-6 text-sm leading-relaxed sm:text-base">
          <li>
            ...
            <C>you.runs-at.dev</C>. Railway shows you the CNAME target to use.
          </li>
          <li>Fork <a className="text-(--color-signal) underline" href="https://github.com/preetmendpara/runs-at.dev">the registry</a> and edit <C>domains/you.json</C>, setting <C>CNAME</C> to the exact value Railway gave you.</li>
      ...
      <Section title="What our schema cannot express">
        <Warning>
          ...
          shows the TXT record at the same hostname as the CNAME (<C>you.runs-at.dev</C> itself),
      ...
      <Section title="How to tell it worked">
        <p className="text-sm leading-relaxed sm:text-base">
          ...
          Visiting <C>https://you.runs-at.dev</C> should then serve the service.
        </p>
      </Section>
    </main>
  );
