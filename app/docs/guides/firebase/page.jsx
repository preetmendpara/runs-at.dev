...
export default function FirebaseGuide() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <Lede>you.runs-at.dev serving a Firebase Hosting site, over HTTPS, via an A record.</Lede>
      ...
      <Section title="Steps">
        ...
        <ol className="list-decimal space-y-2 pl-6 text-sm leading-relaxed sm:text-base">
          <li>
            In the Firebase console: Hosting → Add custom domain → <C>you.runs-at.dev</C> → Quick
      ...
      <Section title="How to tell it worked">
        <p className="text-sm leading-relaxed sm:text-base">
          The Hosting console shows <C>you.runs-at.dev</C> as connected once Firebase has confirmed
          the A record and issued a certificate, which can take a few hours. Visiting{' '}
          <C>https://you.runs-at.dev</C> should then serve the site.
        </p>
      </Section>
    </main>
  );
