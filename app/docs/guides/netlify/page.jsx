...
export const metadata = {
  title: 'Netlify',
  description: 'Point name.runs-at.dev at a Netlify site with a CNAME record.',
  alternates: { canonical: 'https://runs-at.dev/docs/guides/netlify' },
  openGraph: { title: 'Netlify · runs-at.dev' },
};
...
export default function NetlifyGuide() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <Lede>you.runs-at.dev serving a Netlify site, over HTTPS, via CNAME.</Lede>
      ...
      <Section title="Steps">
        ...
        <ol className="list-decimal space-y-2 pl-6 text-sm leading-relaxed sm:text-base">
          ...
          <li>
            ...
            <C>you.runs-at.dev</C>. Netlify needs the domain added here to issue a certificate for
      ...
      <Section title="How to tell it worked">
        <p className="text-sm leading-relaxed sm:text-base">
          Domain management shows the certificate status for <C>you.runs-at.dev</C>. Once it reads
          issued, <C>https://you.runs-at.dev</C> should serve your site.
        </p>
      </Section>
    </main>
  );
