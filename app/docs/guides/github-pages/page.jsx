...
export const metadata = {
  title: 'GitHub Pages',
  description: 'Point name.runs-at.dev at a GitHub Pages site with a CNAME record.',
  alternates: { canonical: 'https://runs-at.dev/docs/guides/github-pages' },
  openGraph: { title: 'GitHub Pages · runs-at.dev' },
};
...
export default function GithubPagesGuide() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <Lede>you.runs-at.dev serving a GitHub Pages site, over HTTPS, via CNAME.</Lede>
      ...
      <Section title="Steps">
        ...
        <ol className="list-decimal space-y-2 pl-6 text-sm leading-relaxed sm:text-base">
          ...
          <li>
            ...
            single line, <C>you.runs-at.dev</C>. This is GitHub&apos;s own custom-domain mechanism,
          ...
          <li>
            ...
            <C>you.runs-at.dev</C> (GitHub reads it from the <C>CNAME</C> file once pushed). Enable
      ...
      <Section title="How to tell it worked">
        <p className="text-sm leading-relaxed sm:text-base">
          ...
          Visiting <C>https://you.runs-at.dev</C> should then serve the Pages site.
        </p>
      </Section>
    </main>
  );
